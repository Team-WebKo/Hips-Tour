...
public interface ReviewService {
    ...
    void update(Long reviewId, UpdateReviewRequestDto requestDto);
    void delete(Long reviewId);
    PageResponseDto<ReviewListResponseDto> getReviewsByPlace(Integer placeId, Pageable pageable);
    PageResponseDto<MyReviewResponseDto> getMyReviews(UserInfo userInfo, Pageable pageable);
